...
annotorious.plugin.SemanticTagging.prototype.onInitAnnotator = function(annotator) {
  autocomplete($(annotator.editor.element).find('textarea'), countries);
}
...
function autocomplete(inp, arr) {
  ...
  inp.bind("input", function(e) {
      ...
      a.setAttribute("id", Math.floor(Math.random() * 10) + "autocomplete-list");
      ...
      for (i = 0; i < arr.length; i++) {
        ...
        if (arr[i].substr(0, val.length).toUpperCase() == val.toUpperCase()) {
          ...
          b.innerHTML += "<input type='text' value='" + arr[i] + "'>";
